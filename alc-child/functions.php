...
<body>
    <header class="bg-blue-600 opacity-75 flex flex-row md:flex-row justify-between items-center p-4">
        ...
        <nav class="flex justify-between items-center p-4">
            ...
            <ul id="nav-links" class="flex space-x-4 flex-col md:flex-row md:space-x-4 md:static absolute top-16 left-0 w-full bg-blue-600 md:bg-transparent p-4 md:p-0 hidden md:flex">
